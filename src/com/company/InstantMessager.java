...
public class InstantMessager implements MessageListener {
            ...
            public void run() {
                try {
                    ...
                    while (!Thread.interrupted()) {
                        ...
                        socket.close();
                        InstantMessager.this.notifyListeners(new User(senderName, socket.getRemoteSocketAddress()), message);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
    ...
    @Override
    public void messageReceived(User senderName, String message) {
